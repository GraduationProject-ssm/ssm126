...
## 2.4 HTML5简介
H5就是HTML5的名称缩写，不仅仅是第五代的HTML标准。目前国内关于H5在入门培训上面有点过度夸张化，其实H5主要是针对于移动端进行布局的这个说法没有错误，但是也是兼容了PC端的，H5新的特性主要从几个方面区别于之前的HTML，从绘画元素，媒体播放元素，都做了很多提升，以及对本地的离线方面的存储做了更优化的支持。顺便也加入了一些新的元素和特性，最显著的是新的表单控件的支持，让之前用HTML写表单属性语句更简洁也更美观，有效的提升了写作效率，从程序开发人员方面解放了大家的思维定向，对用户来讲移动端输入也好，PC端输入也罢，都让输入更加人性更加方便。作为一个全新的标准，让浏览器支持各种二维以及三维的动画，让各种操作平台都能统一风格的浏览同样内容，对中小公司和创业公司来讲，从技术成本角度上就减少了很大的开支，让互联网时代内容更加的繁荣。选择H5技术进行页面开发，是符合当前网页开发潮流的一种选择。
# 3 系统分析
...
### 3.1.1经济可行性
出租车管理系统可以简化工作流程，提供信息处理功能，并可以长期保存数据，在后期的数据查询与编辑中耗时少，提升信息管理效率，其带来的收益比较可观。对于本系统开发，无论是开发需要使用的计算机，还是开发工具等投入的成本很低，计算机是机房的电脑，开发工具是从网上下载安装的，并没有收取费用。
### 3.1.2时间可行性
出租车管理系统是作为本人毕设项目的一个作品，学院也充分预留了制作时间，并且在每个时间段，都安排了相应的任务，所以根据这个时间安排开展工作，是可以对本系统进行设计完成的。
### 3.1.3操作可行性
